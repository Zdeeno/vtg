...
from vtg.msg import MapMakerAction, MapMakerResult, SensorsOutput, SensorsInput, ImageList, DistancedTwist, \
    Features, FeaturesList
from vtg.srv import SetDist, Alignment, Representations
import numpy as np
